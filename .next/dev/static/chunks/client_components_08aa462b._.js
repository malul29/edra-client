...
function useScrollReveal(enabled) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useScrollReveal.useEffect": ()=>{
            ...
            const observe = {
                "useScrollReveal.useEffect.observe": (root)=>{
                    const els = root.querySelectorAll ? root.querySelectorAll(SELECTOR) : [];
                    els.forEach({
                        "useScrollReveal.useEffect.observe": (el)=>io.observe(el)
                    }["useScrollReveal.useEffect.observe"]);
                }
            }["useScrollReveal.useEffect.observe"];
            ...
            const mo = new MutationObserver({
                "useScrollReveal.useEffect": (mutations)=>{
                    mutations.forEach({
                        "useScrollReveal.useEffect": (m)=>{
                            m.addedNodes.forEach({
                                "useScrollReveal.useEffect": (node)=>{
                                    if (node.nodeType === 1) {
...
_s1(BodyWrapper, "6MkMcpDIapbVz6FwpgT2dPCw+qc=", false, function() {
    return [
        useScrollReveal
    ];
});
