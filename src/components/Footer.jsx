            ...
            <div className="footer-column">
              ...
              <div className="footer-contact">
                <div className="contact-item">
                  ...
                  <p>Rose Garden, Blok RRG 1 No. 053<br/>Grand Galaxy City, Jaka Setia<br/>Bekasi Selatan, Kota Bekasi 17147<br/>Indonesia</p>
                </div>
                <div className="contact-item">
                ...
                <div className="contact-item">
                  ...
                  <a href="mailto:studio@edra-architects.com">studio@edra-architects.com</a>
                </div>
              </div>
            </div>
          </div>
