    ...
    >
      ...
      >
        <div className="services-content">
          <div className="services-menu">
            <Link to="/services" className="services-item" onClick={() => setServicesOpen(false)}>
              ARCHITECTURE
            </Link>
            <Link to="/services" className="services-item" onClick={() => setServicesOpen(false)}>
              MANAGEMENT
      ...
      <div className={`mobile-menu ${mobileOpen ? 'active' : ''}`}>
        <nav className="mobile-nav">
          <Link to="/projects" className="mobile-nav-item" onClick={closeMobile}>PROJECTS</Link>
          <Link to="/services" className="mobile-nav-item" onClick={closeMobile}>SERVICES</Link>
          <Link to="/about" className="mobile-nav-item" onClick={closeMobile}>ABOUT</Link>
          <Link to="/contact" className="mobile-nav-item" onClick={closeMobile}>CONTACT</Link>
          <Link to="/blogs" className="mobile-nav-item" onClick={closeMobile}>BLOGS</Link>
        </nav>
