      ...
      case "image":
        return (
          <div key={block.id} className="blog-detail-image-single">
            <img src={block.content} alt={block.caption || "Article image"} />
            {block.caption && (
            ...
            {block.content.map((img, idx) => (
              img && (
                <div key={idx} className="blog-detail-image-grid-item">
                  <img src={img} alt={`Grid image ${idx + 1}`} />
                </div>
              )
            ))}
          </div>
      ...
      <article className="blog-detail-article">
        <div className="blog-detail-container">
          ...
          <aside className="blog-detail-sidebar">
            ...
            {blog.client && (
              <div className="blog-detail-sidebar-section">
                <h3 className="blog-detail-sidebar-title">CLIENT NAME</h3>
                {blog.client.split(',').map((name, idx) => (
                  <p key={idx} className="blog-detail-sidebar-text">{name.trim()}</p>
                ))}
              </div>
            )}
          </aside>
              ...
              {blog.content && blog.content.length > 0 ? (
                ...
                <>
                  ...
                  <div className="blog-detail-image-single">
                    <img src="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?q=80&w=1400&auto=format&fit=crop" alt="Interior light detail" />
                  ...
                  <div className="blog-detail-image-grid">
                    <div className="blog-detail-image-grid-item">
                      <img src="https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?q=80&w=700&auto=format&fit=crop" alt="Living space" />
                    </div>
                    <div className="blog-detail-image-grid-item">
                      <img src="https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?q=80&w=700&auto=format&fit=crop" alt="Bedroom detail" />
                    </div>
                  </div>
      ...
      <section className="blog-detail-related">
        <div className="blog-detail-related-container">
          <div className="blog-detail-related-header">
            ...
            <Link to="/blogs" className="blog-detail-related-link">VIEW ALL</Link>
          </div>
