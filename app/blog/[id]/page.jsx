                ...
                <div className="blog-detail-container">
                    ...
                    <div className="blog-detail-content">
                        ...
                        <div className="blog-detail-featured-image">
                            <Image src={blog.image} alt={blog.title} width={1200} height={600} style={{ width: '100%', height: 'auto', objectFit: 'cover' }} priority />
                        </div>
                            ...
                            <article className="blog-detail-related-card" key={relatedBlog.id}>
                                <Link href={`/blog/${relatedBlog.id}`}>
                                    <div className="blog-detail-related-image">
                                        <Image src={relatedBlog.image} alt={relatedBlog.title} width={600} height={400} style={{ width: '100%', height: 'auto', objectFit: 'cover' }} />
                                    </div>
